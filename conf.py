...
project = 'agent-eval-parsons-problems-post'
dburl = None
...
html_theme_options = {
    ...
    'navbar_title': "agent-eval-parsons-problems-post",
...
html_title = 'agent-eval-parsons-problems-post'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='agent-eval-parsons-problems-post'

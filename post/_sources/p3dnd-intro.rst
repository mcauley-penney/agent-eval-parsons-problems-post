...
.. raw:: html
    ...
    <p>Click on the following link to go the problems: <a id="p3dnd-pwd-post"><font size="+2">Problems</font></a></p>
...
.. raw:: html
    ...
    <script type="text/javascript" >
      ...
      window.onload = function() {
        a = document.getElementById("p3dnd-pwd-post")
        a.href = "p3dnd-pwd-post.html"
      };
